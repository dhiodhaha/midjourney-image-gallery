  ...
  return (
    <div className="group relative break-inside-avoid mb-4">
      <figure className="relative overflow-hidden rounded-lg shadow-lg">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/60 to-transparent opacity-40 group-hover:opacity-100 transition-opacity duration-300">
